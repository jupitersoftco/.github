...
<div align="center" style="padding: 2rem 1rem;">
  ...
  <table width="100%" border="0" cellpadding="10" cellspacing="0" style="max-width: 800px; margin-top: 1rem;">
    <tr valign="top">
      <td width="33%" align="center"><h3>🏗️ Full-Stack Development</h3><p>Building robust web applications with cutting-edge technologies.</p></td>
      <td width="33%" align="center"><h3>☁️ Cloud & DevOps</h3><p>Designing cloud-native architectures for maximum scalability.</p></td>
      <td width="33%" align="center"><h3>🤖 AI Integration</h3><p>Leveraging AI to create intelligent, adaptive solutions.</p></td>
    </tr>
  </table>
</div>
