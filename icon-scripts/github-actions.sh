...
# GitHub Actions icon preserving EXACT authentic workflow automation design with minimal 5% psychedelic drift
github_actions_svg='<g transform="translate(128, 128) scale(0.8) translate(-128, -128)">
